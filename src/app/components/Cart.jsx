                      ...
                      <div className="flex flex-wrap lg:flex-row gap-5  mb-4">
                        ...
                        <div className="w-24">
                          <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                            ...
                            <input
                              type="number"
                              className="focus:outline-none text-center w-[50px] bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-900  outline-none custom-input-number"
